# Generated by Django 5.0.1 on 2024-05-07 13:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noRestaurant', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Gestionnaire.restaurant')),
            ],
        ),
        migrations.AddField(
            model_name='restaurant',
            name='typeRestaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Gestionnaire.typeresto'),
        ),
    ]
